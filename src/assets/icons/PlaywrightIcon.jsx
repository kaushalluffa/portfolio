...
const PlaywrightIcon = ({ width = "40px", height = "40px" }) => {
  return (
    <svg
      height={height ?? "40px"}
      width={width ?? "40px"}
    ...
    >
      ...
      <path
        style={{ fill: "#324A5E" }}
        d="M405.6,163.2c-26.8,15.2-60,29.6-96.8,41.6c-36.8,12-72,19.2-102.8,22.8c2,16.4,5.6,33.6,11.2,50.8
	...
	c-3.6-29.6,17.6-56.4,47.2-60C408,242.8,386.8,269.6,357.2,273.2z"
      ...
      <path
        style={{ fill: "#FFFFFF" }}
        d="M322.4,155.2c-34-2-73.6-8-114.8-18.8s-78.4-24.8-109.2-40c-8,16.4-14.8,34.4-20,54
